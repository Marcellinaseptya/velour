...
class HistoryOngoingView extends GetView<DashboardController> {
  const HistoryOngoingView({super.key});
                ...
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: _buildFilterChip('On process', true, primaryColor),
                    ),
                  ),
                  const SizedBox(width: 8),
                  Expanded(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildPackageCard(
                    ...
                    statusColor: const Color(0xFF1A15C1), // Rich Blue
                    estimatedDate: '19 Oct 2025',
                    location: 'Jalanan Caatur, Yogyakarta',
                    currentStep: 2, // 0=check, 1=check, 2=active
                    activeIcon: Icons.local_shipping_outlined,
                  ),
                  const SizedBox(height: 20),
                ],
